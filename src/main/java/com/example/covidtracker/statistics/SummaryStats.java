...
public class SummaryStats {
    ...
    public Integer getTotalConfirmedCases() {
        ...
        if (jsonObject != null) {
			 ...
			 * else { System.out.println("getTotalCases(): json object is null"); }
			 */
